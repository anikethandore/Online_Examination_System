...
<!-- <div id="over" style=" margin:0; background:white; width:100%; height:100%"></div> -->
...
<button type="button" id="full-screen" hidden></button>


<script src="./adminpanel/js/AgoraRTC_N-4.14.0.js"></script>
<script src="./adminpanel/js/exam.js"></script>

<script>
    name="<?php echo strtoupper($selExmneeData['exmne_fullname']); ?>";
    dataFromUser(name)
